...
WhatsApp: ${formData.whatsapp}`
  ...
  return (
    <div className="min-h-screen bg-white">
      {/* Hero Section */}
      <section className="relative bg-gradient-to-br from-[#FEA62D] to-[#FF8C00] min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <section id="about" className="py-20 bg-gray-50">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <h2 className="text-4xl font-bold text-gray-800 mb-6">Membentuk Inspirasi, Menjelajahi Tradisi</h2>
      ...
      <section className="py-20 bg-white">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold text-gray-800 mb-6">Mengapa Petualangan Gerabah Terbaik Ada di Sini?</h2>
      ...
      <section className="py-20 bg-gray-50">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <h2 className="text-4xl font-bold text-gray-800 mb-6">Temukan Paket Edukasi Gerabah Pilihanmu!</h2>
            <p className="text-xl text-gray-600">Pengalaman Belajar Seru dan Edukatif untuk Semua Kalangan</p>
          </div>

          <div className="grid lg:grid-cols-3 gap-8">
            {/* Paket Keluarga */}
            <Card className="relative border-2 border-[#FEA62D] shadow-xl hover:shadow-2xl transition-shadow duration-300">
              <div className="absolute -top-4 left-1/2 transform -translate-x-1/2">
                <Badge className="bg-[#FEA62D] text-white px-4 py-2 text-sm font-semibold">Best Deal</Badge>
              </div>
              <CardContent className="p-8">
                <div className="text-center mb-6">
                  <h3 className="text-2xl font-bold text-gray-800 mb-2">Paket Edukasi Keluarga</h3>
                  <p className="text-gray-600 mb-4">Liburan Asik, Belajar Kreatif Bersama Keluarga!</p>
            ...
            {/* Paket Pelajar */}
            <Card className="relative border-2 border-green-500 shadow-xl hover:shadow-2xl transition-shadow duration-300">
              <div className="absolute -top-4 left-1/2 transform -translate-x-1/2">
                <Badge className="bg-green-500 text-white px-4 py-2 text-sm font-semibold">Terpopuler</Badge>
              </div>
              <CardContent className="p-8">
                <div className="text-center mb-6">
                  <h3 className="text-2xl font-bold text-gray-800 mb-2">Paket Pelajar / Rombongan</h3>
                  <p className="text-gray-600 mb-4">Petualangan Edukasi Sekolah Paling Seru!</p>
            ...
            <Card className="border-2 border-blue-500 shadow-xl hover:shadow-2xl transition-shadow duration-300">
              <CardContent className="p-8">
                <div className="text-center mb-6">
                  <h3 className="text-2xl font-bold text-gray-800 mb-2">Paket Interaktif / Wawancara</h3>
                  <p className="text-gray-600 mb-4">Gali Ilmu, Asah Karya: Khusus Komunitas & Team Building!</p>
      ...
      <section className="py-20 bg-white">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold text-gray-800 mb-6">Momen-momen Seru di A Trip Edukasika</h2>
            <p className="text-xl text-gray-600">Intip keseruan teman-teman kami saat berkreasi dan belajar!</p>
          </div>
      ...
      <section className="py-20 bg-gray-50">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600">Kisah inspiratif dari guru, orang tua, dan komunitas</p>
          </div>
      ...
      <section id="faq" className="py-20 bg-white">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <h2 className="text-4xl font-bold text-gray-800 mb-6">Sering Ditanyakan</h2>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <div className="text-center mb-12">
              <h2 className="text-4xl font-bold text-gray-800 mb-6">Wujudkan Petualangan Edukasimu Sekarang!</h2>
            ...
            <div className="grid lg:grid-cols-2 gap-12 items-start">
              <Card className="border-0 shadow-xl">
                <CardContent className="p-8">
                  <form onSubmit={handleSubmit} className="space-y-6">
                    ...
                    <div>
                      <label className="block text-sm font-medium text-gray-700 mb-2">Tanggal Kunjungan Pilihan</label>
                      <Input
                        name="tanggal"
                        type="date"
              ...
              <div className="space-y-6">
                <Card className="border-0 shadow-lg">
                  <CardContent className="p-6">
                    <h3 className="text-xl font-semibold text-gray-800 mb-4">Kontak Langsung</h3>
                    <div className="space-y-3">
                      <div className="flex items-center gap-3">
                        <Phone className="h-5 w-5 text-[#FEA62D]" />
                        <div>
                          <div className="font-medium">WhatsApp CS Lidya</div>
                          <div className="text-gray-600">088980674734</div>
                        </div>
                      </div>
                ...
                <Card className="border-0 shadow-lg bg-[#FEA62D]/5">
                  <CardContent className="p-6">
                    <h3 className="text-xl font-semibold text-gray-800 mb-4">Mengapa Booking Sekarang?</h3>
                    <div className="space-y-3">
                      {[
      ...
      <section id="lokasi" className="py-20 bg-white">
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            ...
            <h2 className="text-4xl font-bold text-gray-800 mb-6">Temukan Kami di Peta</h2>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
